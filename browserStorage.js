window.BrowserStorage = (function() {
    /**
     * @param {boolean} deleteWhenBrowserCloses
     * @return {{get: function, set: function}}
     * @constructor
     */
    return function BrowserStorage(label, deleteWhenBrowserCloses) {
        var datatypes = {};
        var datatypeMap = {};
        var datatypeArr = [];
        ...
        addPrimitiveDataType("undefined",
                function serialize(undef) {return "undefined";},
                function deserialize(string) {return undefined;});
        addPrimitiveDataType("null",
                function serialize(nll) {return "null";},
                function deserialize(string) {return null;});
        addDataType(String,
