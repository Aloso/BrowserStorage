...
else{v=k=function(a){return a};var C=h?"":";expires="+new Date(+new Date+307584E5);f={getItem:function(a){if(0<document.cookie.length){var c=document.cookie.indexOf(a+"=");if(-1!==c)return c=c+a.length+1,a=document.cookie.indexOf(";",c),-1===a&&(a=document.cookie.length),decodeURIComponent(document.cookie.substring(c,a))}return""},setItem:function(a,c){document.cookie=a+"="+encodeURIComponent(c)+C+"; path=/"},removeItem:function(a){document.cookie=a+"=;expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/"},
clear:function(){for(var a=document.cookie.split(";"),c=0;c<a.length;c++){var b=a[c],e=b.indexOf("=");b=-1<e?b.substr(0,e):b;document.cookie=b+"=;expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/"}}}}h=f.getItem(g);null!==h&&(e=k(h)||"",b=l(e));var t={get:function(a,c){c&&(e=k(f.getItem(g)||"")||"",b=l(e));return a in b?w(b[a]):null},getOrDefault:function(a,c,d){d&&(e=k(f.getItem(g)||"")||"",b=l(e));return a in b?w(b[a]):c},forEach:function(a,c){c&&(e=k(f.getItem(g)||"")||"",b=l(e));for(var d in b)b.hasOwnProperty(d)&&
a(d,w(b[d]));return t},contains:function(a,c){c&&(e=k(f.getItem(g)||"")||"",b=l(e));return a in b},set:function(a,c){e=k(f.getItem(g)||"")||"";b=l(e);a:if(p[c]){var d=p[""+c];d+=n[d][0](c)}else if(c.constructor&&c.constructor.name&&p[c.constructor.name])d=p[c.constructor.name],d+=n[d][0](c);else{for(d=0;d<r.length;d++)if(c instanceof r[d]){d=p[r[d].name];d=n[d][0](c);break a}throw Error("Missing serializer for object "+c+" (type "+typeof c+")");}if(a in b)b[a]=d,e=u(b);else if(""===e)b={},b[a]=d,
e=u(b);else{var h={};h[a]=d;var m=q;e+="%a"+u(h);q=m+1;b[a]=d}f.setItem(g,v(e));return t},remove:function(a){a in b&&(delete b[a],e=u(b),x(b)?f.removeItem(g):f.setItem(g,v(e)));return t},clear:function(){f.clear();b={};e="";return t},isEmpty:function(a){a&&(e=k(f.getItem(g)||"")||"",b=l(e));return x(b)},length:function(a){a&&(e=k(f.getItem(g)||"")||"",b=l(e));return q}};return t};